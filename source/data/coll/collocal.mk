...
# Remove since all fall back to removed zh.txt: zh_CN.txt zh_HK.txt zh_Hans.txt\
...
COLLATION_SOURCE = $(COLLATION_EMPTY_SOURCE) af.txt am.txt ar.txt\
 ...
 vi.txt wae.txt yi.txt yo.txt \
 zh_Hant.txt zu.txt

# remove: ko.txt zh.txt
